...
export class ShopUseCase {
  ...
  async listActiveShopByUserId(userId: number): Promise<Shop[]> {
    return this.shopRepo.findAllActiveShopsByUserId(userId);
  }
